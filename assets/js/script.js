		...
		if(status == "success"){
	    	...
	    	$('#gpa_semester').on('change', function (e) {
			    ...
			    for(i = 0; i < gpa_evaluation_data.length; i++){
			    	$("#gpa_container").append('<div class="my-3 options-container"><label class="col-12 text-light text-capitalize mb-3">'+gpa_evaluation_data[i].subjectName +'&nbsp;<span class="text-warning text-uppercase mb-3">['+gpa_evaluation_data[i].subjectCode +']</span></label><div class="col-12 btn-group btn-group-toggle btn-group-sm" data-toggle="buttons"> <label class="btn btn-outline-success btn-toggle active"> <input type="radio" name="subject'+[i]+'" value="'+10*gpa_evaluation_data[i].credits+'" autocomplete="off" checked> <b>O</b> </label> <label class="btn btn-outline-success btn-toggle"> <input type="radio" name="subject'+[i]+'" value="'+9*gpa_evaluation_data[i].credits+'" autocomplete="off"> <b>A+</b> </label> <label class="btn btn-outline-success btn-toggle"> <input type="radio" name="subject'+[i]+'" value="'+8*gpa_evaluation_data[i].credits+'" autocomplete="off"> <b>A</b> </label> <label class="btn btn-outline-success btn-toggle"> <input type="radio" name="subject'+[i]+'" value="'+7*gpa_evaluation_data[i].credits+'" autocomplete="off"> <b>B+</b> </label> <label class="btn btn-outline-success btn-toggle"> <input type="radio" name="subject'+[i]+'" value="'+9*gpa_evaluation_data[i].credits+'" autocomplete="off"> <b>B</b> </label> <label class="btn btn-outline-danger btn-toggle"> <input type="radio" name="subject'+[i]+'" value="'+0*gpa_evaluation_data[i].credits+'" autocomplete="off"> <b>U</b> </label> <label class="btn btn-outline-danger btn-toggle"> <input type="radio" name="subject'+[i]+'" value="'+0*gpa_evaluation_data[i].credits+'" autocomplete="off"> <b>AB</b> </label></div></div>')
			    }
